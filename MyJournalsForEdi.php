<html>
	...
	<body>
        ...
        <h1 align="left">  	
	       ...
	       <input type="submit" id="buttonMyCon" name="buttonMyCon" value="My Conferences">
			...
			<input type="submit" id="buttonNew" name="buttonNew" value="New" >
			<p></p>
            </form>
            &emsp;
            <p></p>
		...
		<div id = "section1">
		<b><u>My Published Journals </u></b>      		
                <div id = "section2">
                    <b><u>My Ongoing Journals </u></b>
		            <p></p>
	                Name&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
		            Topic &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
		            Type &emsp;
    ...
    <script type="text/javascript">
        var goToNew = <?php Print($goToNew);?>;
        if(goToNew){
            window.location = 'NewJou.php';
        }
    </script>
    ...
    <script type="text/javascript">
        ...
        if(goToMyConferences){
            window.location = 'MyConferencesForEdi.php';
        }
    </script>
    ...
    <script type="text/javascript">
        ...
        if(goToMyJournals){
            window.location = 'MyJournalsForEdi.php';
        }
    </script>    
