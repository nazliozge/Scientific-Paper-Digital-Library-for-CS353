	...
	<body>
        ...
        <h1 align="left">  	
	       ...
	       <input type="submit" id="buttonMyCon" name="buttonMyCon" value="My Conferences">
             ...
             <h3 > &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;New Publication</h3> 
		...
		<div id = "section1">
                ...
                <div id = "section2">
                    <form>
	                Cited From 	<input id="CitedFrom" name="CitedFrom" type="text"> 
	                <p></p>
		            Contributed By  <input id="ContributedBy" name="ContributedBy" type="text"> 
		            <p></p>
		            </form>

	           </div>
        <form>
	     &emsp; &emsp;Name 	<input id="PubName" name="PubName" type="text"> 
	    <p></p>
		 &emsp; &emsp;Topic  	<input id="PubTopic" name="PubTopic" type="text"> 
		<p></p>
		 &emsp; &emsp;Type  	<input id="PubType" name="PubType" type="text"> 
		<p></p>
	 &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;<input type="submit" id="buttonCreate" name="buttonCreate" value="Create" > 
		</form>
	   </div>
