<html>
    ...
    <body>
        ...
        <h1 align="left"> 
            ...
            <form>
                ...
                <input type="text" id="conf_name" name="conf_name" class="resizedTextbox" />
    ...
    <?php
        ...
        {
            if(!empty($_GET["conf_name"]))
            {
                $conf_name = mysqli_real_escape_string($connection, $_GET['conf_name']);
                $query = "SELECT * FROM conference natural join composition WHERE topic LIKE '%$conf_name%' OR name LIKE '%$conf_name%' ";
        ...
        if($flag)
        {
            ...
            $result = mysqli_query($connection, "SELECT name, topic FROM conference natural join composition") or die(mysqli_error($mysqli));
