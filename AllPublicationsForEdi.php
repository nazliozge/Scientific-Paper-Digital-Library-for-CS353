<html>
	...
	<body>
        ...
        <h1 align="left">  	
	       ...
	       <input type="submit" id="buttonMyCon" name="buttonMyCon" value="My Conferences">
			...
			<input id="Publication" name="PublicationSearch" type="text"> 
		...
		<div id = "section1">
		<b><u>Published Publications </u></b>      		
                <div id = "section2">
                    <b><u>Ongoing Publications </u></b>
		            <p></p>
	                Name&emsp;&emsp;&emsp;&emsp;&emsp;
		            Topic &emsp;&emsp;&emsp;&emsp;&emsp;
	                Type
		            <p></p>
	           </div>
		<p></p>
    ...
    <script type="text/javascript">
        ...
        if(goToAllPublications){
            window.location = 'allPublicationsForEdi.php';
        }
    </script>
